...
fertilized, and upload photos. In list view there are no action buttons; instead
swipe a plant card to the right to mark watering or fertilizing as done. The API
